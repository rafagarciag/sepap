class Problem < ActiveRecord::Base
	...
	validates_presence_of :input, :on=>:create, :message => "Falta archivo 'entrada1'"
	validates_presence_of :output, :on=>:create, :message => "Falta archivo 'salida_esperada1'"
	
	validates_presence_of :input2, :on=>:create, :message => "Falta archivo 'entrada2'"
	validates_presence_of :output2, :on=>:create, :message => "Falta archivo 'salida_esperada2'"
	
	validates_presence_of :input3, :on=>:create, :message => "Falta archivo 'entrada3'"
	validates_presence_of :output3, :on=>:create, :message => "Falta archivo 'salida_esperada3'"
